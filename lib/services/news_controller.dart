...
class NewsController {
  ...
  Future<List<News>> fetchData(String relatedTo) async {
    final response = await dio.get(relatedTo == 'All'
        ? 'https://newsapi.org/v2/everything?q=is&apiKey=4fb918f8585943ecb9e32ab3c4f3167b&language=en'
        : 'https://newsapi.org/v2/everything?q=${relatedTo.toLowerCase()}&apiKey=4fb918f8585943ecb9e32ab3c4f3167b&language=en');
